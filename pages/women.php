...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logo{ 
            font-weight:800; font-size:24px; color:var(--text-dark); text-decoration:none; 
        ...
        .page-title{ 
            text-align:center; font-size:32px; font-weight:700; margin-bottom:30px; position:relative; padding-bottom:15px; 
            letter-spacing: -0.5px;
        ...
        .filter-label{ font-weight:600; font-size:14px; color:var(--text-dark); letter-spacing: 0.02em; }
        .filter-select{ 
            padding:8px 12px; border:1px solid var(--border-color); border-radius:var(--radius-sm); background:var(--white);
        ...
        .card-badge{ position:absolute; top:12px; left:12px; background:var(--primary); color:white; padding:5px 10px; border-radius:var(--radius-sm); font-size:12px; font-weight:700; z-index:2; letter-spacing: 0.03em; }
        ...
        .card-title{ 
            font-size:16px; font-weight:600; margin-bottom:8px; color:var(--text-dark); 
            display:-webkit-box; -webkit-line-clamp:2; -webkit-box-orient:vertical; overflow:hidden; height:44px; line-height:1.4;
            letter-spacing: 0.02em;
        }
        .price-container{ display:flex; align-items:center; gap:8px; margin-bottom:12px; flex-wrap:wrap; }
        .current-price{ font-weight:700; font-size:18px; color:var(--primary); letter-spacing: 0.02em; }
        .original-price{ font-size:14px; text-decoration:line-through; color:var(--text-light); letter-spacing: 0.02em; }
        .discount-percent{ font-size:13px; color:var(--primary); font-weight:600; background:var(--primary-light); padding:2px 6px; border-radius:4px; letter-spacing: 0.02em; }

        .size-selector{ margin-top:auto; padding-top:10px; margin-bottom:15px; }
        .size-title{ font-size:13px; font-weight:600; margin-bottom:8px; color:var(--text-dark); letter-spacing: 0.02em; }
        ...
        .size-option{ border:1px solid var(--border-color); min-width:32px; height:32px; font-size:12px; font-weight:600; border-radius:var(--radius-sm); cursor:pointer; user-select:none; transition:all .2s; display:grid; place-items:center; flex-shrink:0; background:transparent; letter-spacing: 0.02em; }
        ...
        .action-btn{ 
            width:100%; padding:12px; border:1px solid; border-radius:var(--radius-sm); font-size:14px; font-weight:600; cursor:pointer; 
            transition:all .2s; display:flex; align-items:center; justify-content:center; gap:8px; text-decoration:none; background:var(--white);
            letter-spacing: 0.03em;
        }
        ...
        .toast{ position:fixed; bottom:25px; left:50%; transform:translateX(-50%) translateY(100px); background:var(--text-dark); color:white; padding:14px 24px; border-radius:var(--radius-md); box-shadow:var(--shadow); z-index:1001; opacity:0; transition:all .4s; font-size:15px; max-width:90%; text-align:center; display:flex; align-items:center; gap:10px; letter-spacing: 0.02em; }
        ...
        .empty-state p{ font-size:18px; margin-bottom:25px; letter-spacing: 0.02em; }
        .cat {
            display: none;
        }
