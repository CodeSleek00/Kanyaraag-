...
.search-container input:focus {
  outline: none;
  border-color: #C75D2c;
  box-shadow: 0 0 0 2px rgba(199, 93, 44, 0.2);
}
...
/* Mobile Sale Banner */
.mobile-sale-banner {
  background: linear-gradient(135deg, #C75D2c, #e67e22);
  color: white;
  padding: 15px;
  border-radius: 8px;
  margin-bottom: 20px;
...
<div class="container">
    ...
    <div class="card">
      <img src="12.jpeg" alt="24 Hr Dispatch">
    ...
    <div class="card">
      <img src="12.jpeg" alt="Wedding Wardrobe">
      <div class="card-content">
    ...
    <div class="card">
      <img src="12.jpeg" alt="Bestsellers">
      <div class="card-content">
        <h3>Bestsellers</h3>
